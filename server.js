  ...
  try {
    ...
    if (wantsForce) {
      try {
        ...
        // Transient refresh failure must NOT block the sync — log and fall
        // through to a normal cached sync below.
        console.warn('[sync_account] /transactions/refresh failed:',
